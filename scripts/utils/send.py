...
APN = "web.vodafone.de"
Sci_Name, Com_name, Confidence, Lat, Lon, Cutoff, Sens, Overlap = sys.argv[1:]
url = f"http://api.thingspeak.com/update?api_key=HPDZ4040M5DOZAZE&field1={Sci_Name}&field2={Com_name}&field3={Confidence}&field4={Lat}&field5={Lon}&field6={Cutoff}&field7={Sens}&field8={Overlap}"
